...
namespace PetHelp.Server.Migrations
{
    ...
    [Migration("20230104213948_dodanie_tabeli_Szczepien")]
    partial class dodanie_tabeli_Szczepien
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetHelp.Server.Models.Log", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PetHelp.Server.Models.SzczepienieRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("CzyOdbyte")
                        .HasColumnType("bit");

                    b.Property<DateTime>("Data")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DataInnyTermin")
                        .HasColumnType("datetime2");

                    b.Property<int>("SzczepienieType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PetHelp.Server.Models.Log", b =>
                {
                    b.HasOne("PetHelp.Server.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserID");
            ...
            modelBuilder.Entity("PetHelp.Server.Models.Zwierze", b =>
                {
                    ...
                    b.HasOne("PetHelp.Server.Models.rasy", "rasa")
                        .WithMany()
